...
//g++ -O3 binary_search.t.cpp binary_search.cpp -o binary_search.exe
//cl /Fo.\obj\ /EHsc /O2 binary_search.t.cpp binary_search.cpp /link /out:binary_search.exe
...
{
    binary_search_main(argc, argv, true, true);	

...
//Adaptado de: https://en.cppreference.com/w/cpp/feature_test
//Funcionalidades que o compilador suporta: https://en.cppreference.com/w/cpp/compiler_support
//Feature-Test Macros and Policies: https://isocpp.org/std/standing-documents/sd-6-sg10-feature-test-recommendations
//Maio 2021

//g++ -O3 cpp_feature_testing.cpp -o cpp_feature_testing.exe
//g++-10 -std=c++20 -O3 cpp_feature_testing.cpp -o cpp_feature_testing.exe
//cl /Fo.\obj\ /EHsc /Zc:__cplusplus /O2 cpp_feature_testing.cpp /link /out:cpp_feature_testing.exe
...
inline void print_compiler_feature(const CompilerFeature& x) {
    ...
    //const int max_name_length = 44; //< Update if necessary

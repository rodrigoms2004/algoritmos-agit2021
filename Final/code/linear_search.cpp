...
//g++ -O3 linear_search.t.cpp linear_search.cpp -o linear_search.exe
//cl /Fo.\obj\ /EHsc /O2 linear_search.t.cpp linear_search.cpp /link /out:linear_search.exe
...
{
    linear_search_main(argc, argv, true, true);	

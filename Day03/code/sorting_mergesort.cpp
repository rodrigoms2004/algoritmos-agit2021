...
//g++ -O3 sorting_mergesort.t.cpp sorting_mergesort.cpp -o sorting_mergesort.exe
//cl /Fo.\obj\ /EHsc /O2 sorting_mergesort.t.cpp sorting_mergesort.cpp /link /out:sorting_mergesort.exe
...
{
    sorting_mergesort_main(argc, argv, true, true);	
